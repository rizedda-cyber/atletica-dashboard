        ...
        if tipo_form == "🏃 Pista (corsa)":
            ...
            with st.form("form_corsa", clear_on_submit=True):
                ...
                for i in range(1, 13):
                    ...
                    if dist_sel == "Altro":
                        dist_custom = c1.number_input("Distanza personalizzata (m):", min_value=1, max_value=10000, value=180, step=1, key=f"dist_custom_{i}", label_visibility="collapsed")
